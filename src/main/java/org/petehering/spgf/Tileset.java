...
public class Tileset
{
    ...
    public Tileset(BufferedImage[] tileImages, int tileWidth, int tileHeight)
    {
        this.images = requireNonNull(tileImages);
        this.tileWidth = requireGreaterThan(0, tileWidth);
        this.tileHeight = requireGreaterThan(0, tileHeight);
        this.hidden = new boolean[tileImages.length];
        this.blocked = new boolean[tileImages.length];
    }
